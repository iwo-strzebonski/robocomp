...
import { faBars, faMoon, faSignOutAlt, faGaugeSimpleHigh } from '@fortawesome/free-solid-svg-icons'
...
// Regular icons
library.add(faSun, faEye, faEyeSlash)
// Solid icons
library.add(faMoon, faBars, faSignOutAlt, faGaugeSimpleHigh)
