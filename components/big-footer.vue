  ...
  <div class="flex flex-col items-center bg-neutral-300 p-8 gap-8 z-0">
    ...
    <span class="inline-flex gap-4">
      <NuxtLink to="http://www.integra.agh.edu.pl/" target="_blank" rel="noopener noreferrer">
        <NuxtImg src="https://i.postimg.cc/T2NmZ0t5/integra-logo.png" alt="KN Integra Logo" width="100" height="100" />
      </NuxtLink>

      <NuxtLink to="/">
        <NuxtImg src="/icon.png" alt="ROBOCOMP Logo" width="100" height="100" />
      </NuxtLink>
    </span>
  </div>
</template>
